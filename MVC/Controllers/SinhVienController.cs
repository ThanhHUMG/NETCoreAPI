...
namespace MVC.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MSV,HoTen,Khoa")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(double id, [Bind("MSV,HoTen,Khoa")] SinhVien sinhVien)
        {
            if (id != sinhVien.MSV)
            {
                return NotFound();
        ...
        {
            return _context.SinhVien.Any(e => e.MSV == id);
        }
    }
}
